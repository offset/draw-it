...
\hypertarget{classLineFinder_a9dc74b9d8732aefeefdf8d439e1e043e}{\index{Line\-Finder@{Line\-Finder}!save\-To\-Disk@{save\-To\-Disk}}
\index{save\-To\-Disk@{save\-To\-Disk}!LineFinder@{Line\-Finder}}
\subsubsection[{save\-To\-Disk}]{\setlength{\rightskip}{0pt plus 5cm}int Line\-Finder\-::save\-To\-Disk (
\begin{DoxyParamCaption}
\item[{cv\-::\-Mat}]{image, }
\item[{std\-::string}]{file\-Name = {\ttfamily \char`\"{}../level.txt\char`\"{}}}
\end{DoxyParamCaption}
)}}\label{classLineFinder_a9dc74b9d8732aefeefdf8d439e1e043e}


Stores the image in a format S\-F\-M\-L can read for further processing. 

\begin{DoxyAuthor}{Author}
zemann \begin{DoxyVerb}  \param image[in]: The image to be saved

  @return error/success code\end{DoxyVerb}
